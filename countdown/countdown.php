...
$count_from = date("Y-m-d H:i:s", time()); // current time -- NO NEED TO CHANGE
...
function convert_to_time(secs)
{
	...
	if (mm < 10) { mm = "0"+mm; }	
	if (hh < 10) { hh = "0"+hh; }	
	if (mm == 0) { return (ss+" Sec. remaining"); }	
	else if (hh == 0) { return (mm+":"+ss+" Sec. remaining"); }	
	else if (dd == 0) { return (hh+":"+mm+":"+ss+" Sec. remaining"); }	
	else {	
		if (dd > 1) { return (dd+" days "+hh+":"+mm+":"+ss+" Sec. remaining"); }
...
function do_cd()
{
	...
	{	
		...
		?>
		// change text
		document.getElementById('cd').innerHTML = "<?php echo $_GET['data'];?>";
		<?php } ?>
